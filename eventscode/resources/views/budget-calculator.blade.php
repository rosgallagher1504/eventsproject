...
<?php $con = new mysqli("localhost","root","","event_budget_calculator"); ?>
...
<body>
    ...
    <span class="navbar-brand mb-0 h1 text-center">Events Budget Calculator</span>
    </nav>
    <br><br><br>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                <form action="process.php" method="POST">
                    <div class="form-group">
                        <label for="budgetTitle">Event Name</label>
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <input type="text" name="budget" class="form-control" id="budgetTitle" placeholder="Enter Event Name" required autocomplete="off"  value="<?php echo $name; ?>">
                    </div>
                    <div class="form-group">
                        <label for="amount">Cost</label>
                        <input type="text" name="amount" class="form-control" id="amount" placeholder="Enter the Cost of the Event" required  value="<?php echo $amount; ?>">
                    </div>
                    <?php if($update == true): ?>
